...
[给我来一份精致昏睡红茶] 叫一杯先辈特调红茶(bot需具有群管理权限)
'''.strip())
...
@sv.on_rex(r'(.*)(狗|苟|臭|早泄)(群主|管理|布丁)(.*)')
async def sleep_1h(bot, ev):
    await util.silence(ev, 1*20*60, skip_su=False)

@sv.on_rex(r'(来|來)(.*(份|碗)(.*)(红茶|茶)(.*))')
